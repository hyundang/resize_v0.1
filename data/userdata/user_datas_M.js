...
const cody_M = [
    ...
    },
    {
        ...
        answers: [
            ...
            {
                question : '상의',
                datas : ['민소매', '반팔 티셔츠', '긴팔 티셔츠', '7부 티셔츠', '반팔 니트', '맨투맨', '후드 티셔츠', '셔츠/남방', '기타', '없음'],
                inputText: '예) 목폴라 티셔츠 싫어요!'
            },
            {
                question : '바지',
                datas : ['청바지', '면바지', '반바지', '슬랙스', '트레이닝 바지', '린넨 바지', '기타', '없음'],
                inputText: '예) 목폴라 티셔츠 싫어요!'
            },
            {
                question : '아우터',
                datas : ['가디건', '항공 점퍼', '야상', '후드집업', '후리스 자켓', '블레이저 자켓', '조끼', '트렌치 코트', '청자켓', '라이더 자켓', '바람막이', '기타', '없음'],
                inputText: '예) 목폴라 티셔츠 싫어요!'
            },
        ], 
    },
